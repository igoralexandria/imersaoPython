...
def home(request):
    ...
    context = {'produtos': produtos, 'carrinho': len(request.session['carrinho']), 'categorias': categorias, }
...
def produto(request, id):
    ...
    context = {'produto': produto, 'carrinho': len(request.session['carrinho']), 'categorias': categorias, 'erro': erro}
